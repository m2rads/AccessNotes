# Getting Started with AccessNotes
...
<p align="center">
  <img src="/media/accessnotes.png" width="350" title="hover text">
  <img src="/media/accessnotes.png" width="350" alt="accessibility text">
</p>
...
## Run the app as a React application

To run the app as a react application run the following command.

`yarn start` or `npm start`

## Run the app as a Chrome Extension
